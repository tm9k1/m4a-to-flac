...
4. Run **`music-flac sync --dry-run`**, then **`music-flac sync`** (see [Sync and backends](sync-and-backends.md)).
...
| [Sync and backends](sync-and-backends.md) | **hifi** (search → manifest → CDN), dry-run, force, atomic writes |
